...
PROVINCES = [
    "伊豆","相模","武蔵","安房","上総","下総","常陸","山城","大和","河内",
        "和泉","摂津","伊賀","伊勢","志摩","尾張","三河","遠江","駿河","甲斐",
            "信濃","飛弾","美濃","近江","越前","加賀","能登","越中","越後","佐渡",
                "丹波","丹後","但馬","因幡","伯耆","出雲","石見","隠岐","播磨","美作",
                    "備前","備中","備後","安芸","周防","長門","紀伊","淡路","阿波","讃岐",
                        "伊予","土佐","筑前","筑後","豊前","豊後","肥前","肥後","日向","大隅",
                            "薩摩","壱岐","対馬","上野","下野","陸奥","出羽","若狭","吉備"
                            ]
